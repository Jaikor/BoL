...
function Initiate()
local scriptName = "JKUdyrFree Imba Shit"
printMessage = function(message) print(""..scriptName..": "..message.."") end
if FileExist(LIB_PATH.."SourceLib.lua") then
require 'SourceLib'
else
printMessage("Downloading SourceLib, please wait whilst the required library is being downloaded.")
DownloadFile("https://raw.github.c...n/SourceLib.lua",LIB_PATH.."SourceLib.lua", function() printMessage("SourceLib successfully downloaded, please reload (double [F9]).") end) 
return true
end
local libDownloader = Require(scriptName)
libDownloader:Add("VPrediction", "https://raw.github.c...rediction.lua")
libDownloader:Add("SOW", "https://raw.github.c...ommon/SOW.lua")
libDownloader:Check()
...
SourceUpdater(scriptName, version, "raw.github.com", "/Jaikor/BoL/master/JKUdyrFree.lua", SCRIPT_PATH..GetCurrentEnv().FILE_NAME, "/Jaikor/BoL/master/Versions/JKudyrFree.version"):CheckUpdate()
return false
end
...
DrawHandler:CreateCircle(myHero,Udyr.R["range"],1,{255, 255, 255, 255}):AddToMenu(Menu.Draw, "R Range", true, true, true):LinkWithSpell(SpellR, true)
